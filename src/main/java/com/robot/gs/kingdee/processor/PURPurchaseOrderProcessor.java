...
import com.robot.gs.kingdee.converter.PURPurchaseOrderConverter;
...
@Slf4j
public class PURPurchaseOrderProcessor extends KingdeeCommonDataProcessor {

    private final PURPurchaseOrderConverter converter = new PURPurchaseOrderConverter();

    public PURPurchaseOrderProcessor(ApiNameEnum apiNameEnum, String dbName, String tbName, LocalDate startDate,
    ...
    public void save(Statement stmt, List<String> dataList, Boolean isFirst) throws SQLException {
        ...
        for (String data : dataList) {
            PURPurchaseOrder e = converter.from(data);
            ...
            builder.append("STRUCT ('")
                    ...
                    .append(e.getFGsPr()).append("', '")
                    .append(e.getFOraCombo()).append("', '")
                    .append(e.getPOOrderEntry()).append("', '")
