...
public class ErrorCodeRecordConditionFactory extends ConditionFactory{
    private final static String FILTER_FIELD ="updateTime";
    public ErrorCodeRecordConditionFactory(LocalDate startDate) {
        super(startDate);
    }

    public ErrorCodeRecordConditionFactory(String startDate) {
        super(startDate);
    }

    public ErrorCodeRecordConditionFactory() {
