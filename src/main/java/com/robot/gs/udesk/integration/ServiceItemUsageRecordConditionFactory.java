...
public class ServiceItemUsageRecordConditionFactory extends ConditionFactory{
    private final static String FILTER_FIELD ="updateTime";

    public ServiceItemUsageRecordConditionFactory(LocalDate startDate) {
        super(startDate);
    }

    public ServiceItemUsageRecordConditionFactory(String startDate) {
        super(startDate);
    }

    public ServiceItemUsageRecordConditionFactory() {
