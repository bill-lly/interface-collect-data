...
public class ReplacementPartUseFactory extends ConditionFactory{
    private final static String FILTER_FIELD ="updateTime";

    public ReplacementPartUseFactory(LocalDate startDate) {
        super(startDate);
    }

    public ReplacementPartUseFactory(String startDate) {
        super(startDate);
    }

    public ReplacementPartUseFactory() {
